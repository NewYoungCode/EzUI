...
namespace ezui {
	namespace detail {
		...
		public:
			EZUI_API String()noexcept;
			EZUI_API virtual ~String();

			EZUI_API String(const String& right)noexcept;
			EZUI_API String(String&& right)noexcept;
			EZUI_API String& operator=(const String& right)noexcept;
			EZUI_API String& operator=(String&& right)noexcept;

			EZUI_API String(const char* szbuf)noexcept;
			EZUI_API String(const char* pStr, size_t count)noexcept;
			EZUI_API String(const std::string& str)noexcept;

			EZUI_API String(const wchar_t* szbuf)noexcept;
			EZUI_API String(const std::wstring& wstr)noexcept;
			...
			//判断字符串是否包含一个字符串
			EZUI_API bool contains(const String& str)const noexcept;
			//去除前后空格
