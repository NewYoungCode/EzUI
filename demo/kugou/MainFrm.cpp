...
void MainFrm::InitForm() {
	...
	//找到三个Frame
	titleFrame = (Frame*)this->FindControl("titleFrame");
	centerFrame = (Frame*)this->FindControl("centerFrame");
	bottomFrame = (Frame*)this->FindControl("bottomFrame");
	...
	do {
		...
		if (args.EventType == Event::OnMouseDown) {
			...
			if (sender->Name == "dellocal") {
				...
				vlistLocal->RemoveChild(songItem);
